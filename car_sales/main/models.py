...
class Cars(models.Model):
    ...
    used=models.BooleanField(choices=[(True,'Так'),(False,'Ні')],null=True,blank=True)
    mileage=models.DecimalField(max_digits=30,decimal_places=2,null=True,blank=True)
