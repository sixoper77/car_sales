...
class Cars(models.Model):
    ...
    used=models.BooleanField(choices=[(True,'Так'),(False,'Ні')])
    mileage=models.DecimalField(max_digits=30)
    air_conditioner=models.CharField(choices=CONDITIONERS,verbose_name='Кондиционеры')
    gearbox=models.CharField(choices=GEARBOX,verbose_name='Коробки передач')
    slug = models.SlugField(max_length=255)
